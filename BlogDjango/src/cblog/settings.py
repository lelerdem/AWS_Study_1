...
DATABASES = {
    'default': {
        ...
        'HOST': 'database1.c8l7ftgadgtp.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsproject-erdem-blog' # please enter your s3 bucket name
